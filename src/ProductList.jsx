...
function ProductList({ onHomeClick }) {
    ...
    const handlePlantsClick = (e) => {
        ...
        setShowCart(!showCart); // Hide the cart when navigating to About Us
    };
                            ...
                            <div className="product-list"> {/* Container for the list of plant cards */}
                                {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                                    <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                        ...
                                        <button
                                            className={addedToCart[plant.name] ? 'product-button added-to-cart' : 'product-button'} // Add 'added-to-cart' class if the plant is added to the cart
                                            //disabled={addedToCart[plant.quantity === 0]} // Disable the button if the plant is added to the cart
